// Link -> https://www.learnopengl.com/Advanced-OpenGL/Stencil-testing
...
{
    class StencilTesting : public Lecture
    {
    public:
        StencilTesting(int width, int height);
    ...
    private:
        GettingStarted::Shader m_Shader, m_OutlineShader;
