// Link -> https://www.learnopengl.com/Lighting/Basic-Lighting
...
namespace Lighting
{
    class BasicLighting : public Lecture
    {
    public:
        BasicLighting(int width, int height);
    ...
    private:
        ...
        uint32_t m_VAO, m_CubeVAO, m_VBO;
        float m_AmbientStrength, m_SpecularStrength, m_Shininess;
