// Link -> https://www.learnopengl.com/Lighting/Materials
...
namespace Lighting
{
    class Materials : public Lecture
    {
    public:
        Materials(int width, int height);
    ...
    private:
        ...
        glm::vec3 m_LightAmbientColor, m_LightDiffuseColor, m_LightSpecularColor;
        glm::vec3 m_MaterialAmbientColor, m_MaterialDiffuseColor, m_MaterialSpecularColor;
