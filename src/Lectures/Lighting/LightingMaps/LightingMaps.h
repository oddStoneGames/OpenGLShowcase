// Link -> https://www.learnopengl.com/Lighting/Lighting-maps
...
namespace Lighting
{
    class LightingMaps : public Lecture
    {
    public:
        LightingMaps(int width, int height);
    ...
    private:
        void ChooseCustomTexture(uint32_t textureID);
